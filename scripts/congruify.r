...
ml.tree<-read.tree(file="/home/mpnelsen/timescaling_doug/RAxML_bestTree.result")
outtree.name<-"/home/mpnelsen/timescaling_doug/RAxML_bestTree.result_treepl_prime.tre"
treepl.filename<-"/home/mpnelsen/timescaling_doug/RAxML_bestTree.result_primefile.txt"
ml.tree.path<-"/home/mpnelsen/timescaling_doug/RAxML_bestTree.result"
...
ml.tree<-read.tree(file="/home/mpnelsen/timescaling_doug/RAxML_bestTree.result")
ml.tree.path<-"/home/mpnelsen/timescaling_doug/RAxML_bestTree.result"
outtree.name<-"/home/mpnelsen/timescaling_doug/RAxML_bestTree.result_treepl_CV.tre"
...
congruify.to.treepl.cv.maker<-function(filepath=NULL,reftree=NULL,target.tree=NULL,cviter=100,cvstart=0.000001,cvstop=1000,cvmultstep=0.1,cviterno=2,randomcviterno=10,numsites=NULL,penalty=NULL,n.threads=1,ml.tree.path=NULL,outtree.name=NULL){
		...
		write(new.vector,paste("cv_configfile_","RAxML_bestTree.result",sep=""))
}
